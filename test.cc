    ...
    while(true) {
        ...
        if (cmd == "setup") {
            ...
            if ((p1 == "human" || p1 == "computer1" || p1 == "computer2" || p1 == "computer3" || p1 == "computer4") &&
                ...
                if (p1 == "human") player1 = &Human{};
                else if (p1 == "computer1") player1 = &Level1{};
                else if (p1 == "computer2") player1 = &Level2{};
                else if (p1 == "computer3") player1 = &Level3{};
                else player1 = &Level4{};

                if (p2 == "human") player2 = &Human{};
                else if (p2 == "computer1") player2 = &Level1{};
                else if (p2 == "computer2") player2 = &Level2{};
                else if (p2 == "computer3") player2 = &Level3{};
                else player2 = &Level4{};
